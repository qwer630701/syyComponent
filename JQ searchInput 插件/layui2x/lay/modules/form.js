        ...
        select: function () {
          ...
          f.each(function (e, l) {
            ...
            var v = "string" == typeof r.attr("lay-search"),
              ...
              m = i(['<div class="' + (v ? "" : "layui-unselect ") + a + (c ? " layui-select-disabled" : "") + '">', '<div class="' + n + '"><input type="text" placeholder="' + p + '" value="' + (d ? f.html() : "") + '" ' + (v ? "" : "readonly") + ' class="layui-input' + (v ? "" : " layui-unselect") + (c ? " " + o : "") + '">', '<i class="layui-edge"></i></div>', '<dl class="layui-anim layui-anim-upbit' + (r.find("optgroup")[0] ? " layui-select-group" : "") + '">' + function (e) {
                var i = [];
  ...
  var d = function () {
      ...
      return layui.each(d, function (e, l) {
        var r = i(this),
          ...
          d = r.val();
        var requiredMsg = r.attr("lay-required-msg");
        if (r.removeClass(u), layui.each(o, function (e, i) {
            var o, f = "",
              y = "function" == typeof a[i];
            if (a[i]) {
              var o = y ? f = a[i](d, l) : !a[i][0].test(d);
              if (requiredMsg && "required" === i ? f = requiredMsg : f = f || a[i][1], o && "required" === i || o && d) {
                return "tips" === c ? t.tips(f, r, {
                  tips: 1
                }) : "alert" === c ? t.alert(f, {
                  title: "提示",
                  shadeClose: !0
